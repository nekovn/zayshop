@php
    ...
    $spanForgotPass = $form::spanForgotPassword('admin.login');
    $formOpen       = Form::open(['route'=>'admin.login.submit', 'method'=>'POST', 'name'=>'contact', 'id'=>'form-'.$functionId, 'class'=>'', 'role'=> 'form', 'autocomplete' => 'off']);
