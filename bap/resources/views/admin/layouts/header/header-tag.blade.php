...
<link href="{{asset('assets/dist/libs/toastr/toastr.min.css')}}" rel="stylesheet"/>

<script src="{{asset('assets/dist/libs/superagent/superagent.min.js')}}" defer></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js" defer></script>
<script src="{{asset('assets/dist/libs/toastr/toastr.min.js')}}" defer></script>

<script src="js/app.config.js" defer></script>


{{--<script src="{{asset('assets/dist/libs/coreui/js/coreui.bundle.min.js')}}" defer></script>--}}
